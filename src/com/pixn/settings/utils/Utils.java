...
package com.pixn.settings.utils;
...
public final class Utils {
    private static final String TAG = "PixNSettingsUtils";
    ...
    public static boolean deviceSupportsFlashLight(Context context) {
        ...
        try {
            ...
            for (String id : ids) {
                ...
                Boolean pixnAvailable = c.get(CameraCharacteristics.FLASH_INFO_AVAILABLE);
                Integer lensFacing = c.get(CameraCharacteristics.LENS_FACING);
                if (pixnAvailable != null
                        && pixnAvailable
                        && lensFacing != null
